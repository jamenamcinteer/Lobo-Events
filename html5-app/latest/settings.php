...
if($device['app_version'] != '1.0.3' && $device['app_version'] != '1.0.4'){echo ' <span style="color:red;"> (Needs Updating)</span>';}//UPDATE VERSION WHEN PUBLISHED TO GOOGLE PLAY
if($device['app_version'] == '1.0.4'){echo ' <span style="color:green;"> (BETA)</span>';}//UPDATE VERSION WHEN PUBLISHED TO GOOGLE PLAY
if($device['app_version'] == '1.0.3'){echo ' <span style="color:green;"> (Latest)</span>';}//UPDATE VERSION WHEN PUBLISHED TO GOOGLE PLAY
echo'</span><br>';
}
