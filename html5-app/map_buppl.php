    ...
    <script type="text/javascript">
	    ...
	    {
	    navigator.geolocation.getCurrentPosition(initialize,errorMsg,{enableHighAccuracy: true});
	    }
	...
	google.maps.event.addListener(map, 'zoom_changed', function() {
		...
		if(zoom < 17){layer.setMap(null);}
		if(zoom >= 17){layer.setMap(map);}
		});
...
function setPos(){
    	  ...
    	  if (navigator.geolocation)
	    {
	    navigator.geolocation.getCurrentPosition(startPos,errorMsg,{enableHighAccuracy: true});
	    }
	  }
function updatePos(){
