...
$locs = array($loc_title,$loc_desc,"$loc_lat,$loc_long",'','building');	
...
foreach ($locations as $loc) {
	...
	$locs = array($loc_title,$loc_desc,"$loc_lat,$loc_long",'','gym');	
...
foreach ($locations as $loc) {
	...
	$locs = array($loc_title,$loc_desc,"$loc_lat,$loc_long",'','library');	
...
foreach ($locations as $loc) {
	...
	$locs = array($loc_title,$loc_desc,"$loc_lat,$loc_long",'','dining');	
...
foreach ($locations as $loc) {
	...
	$locs = array($loc_title,$loc_desc,"$loc_lat,$loc_long",'','location');	
